...
//   // TODO: This component needs plant data from API (SAMPLE_PLANTS removed)
//   // Temporarily disabled until plant data API is available
//   return (
//     <div className="p-4 bg-yellow-50 border border-yellow-200 rounded">
//       <p className="text-yellow-800">
//         ⚠️ Plant instances grid is temporarily disabled. Plant data API integration needed.
//       </p>
//     </div>
//   );

//   /* Original code - commented out until SAMPLE_PLANTS data is available
...
//   // TODO: Replace with actual plant data from API
//   // const plant = SAMPLE_PLANTS.find(p => p.id === plantId);

//   if (instances.length === 0) return null;

//   const getInstancePrice = (instance: PlantInstance) => {
//     return instance.price || 0; // TODO: Get default price from plant data API
//   };
//   */
// }
