...
export const SIDEBAR_ITEMS_BY_ROLE: Record<UserRole, SidebarItem[]> = {
  ...
  manager: [
    ...
    { label: 'Nhân viên cửa hàng', href: '/manager/store-users', icon: 'users' },
    { label: 'Quản lý hàng hóa', href: '/manager/store-catalog', icon: 'catalog' },
  ...
  staff: [
    ...
    { label: 'Quản lý nhân viên chăm sóc', href: '/staff/caretaker-management', icon: 'users'},
    { label: 'Yêu cầu dịch vụ', href: '/staff/service-request', icon: 'requests' },
    { label: 'Quy trình dịch vụ', href: '/staff/service-progress', icon: 'scheduled' },
